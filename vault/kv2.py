...
def write(ctx: Context, mount: str = 'secret', path: str = '', secret: dict = {}) -> json:
...
def delete(ctx: Context, mount: str = 'secret', path: str = '') -> json:
...
def read(ctx: Context, mount: str = 'secret', path: str = '') -> json:
...
def list(ctx: Context, mount: str = 'secret', path: str = '') -> json:
